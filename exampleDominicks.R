...
wber <- data.table::fread("C:/Users/dki007/OneDrive - UiT Office 365/SOK-3008_Fall_2024/wber.csv",
...
upcber <- data.table::fread("C:/Users/dki007/OneDrive - UiT Office 365/SOK-3008_Fall_2024/upcber.csv",
...
#---------------------------------------------- Alternative ways of treating the missing values-------
