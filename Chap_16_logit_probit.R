...
# The average marginal effect (AME) is the average of the marginal effects for each observation in the data set.
...
#' Here we do not interpreter the coefficients, or the magnitude of the coeff. 
